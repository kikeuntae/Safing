...
<head>
	...
	function notice_delete(board_id){
		swal({
			  title: "게시글 삭제",
			...
			.then((willDelete) => {
			  if (willDelete) {
				  location.href="notice_delete.bo?board_id="+board_id;
			  } else {
				return false;
			  }
		});
...
<body>
<!-- Navigation -->
<form action="noticemanage.no" method="post">
	  ...
	  <div class="collapse navbar-collapse text-center container" id="navbarSupportedContent">
	    <ul class="navbar-nav mr-auto">
	      ...
	      <c:if test="${loginInfo.member_admin eq 'y'}">
		      <li class="nav-item">
		        <label>
		            <a class="nav-link sub-category" href="noticemanage.no">
...
<!-- Product List -->
<table class="table w-70 my-sm-4 table-center">
  ...
  <tbody >
	...
	<c:forEach items="${page.list}" var="vo">
		<tr>
			...
			<td>
				<div class="manage-image-2">
					<a  onclick="notice_delete(${vo.board_id})">
						<img class="img-size-21"  src="shop_img/delete.png">
					</a>
				</div>
			</td>
		</tr>
