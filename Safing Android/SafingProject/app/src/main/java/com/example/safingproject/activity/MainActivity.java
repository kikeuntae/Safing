...
import com.example.safingproject.activity.home.CamInfoActivity;
import com.example.safingproject.activity.home.HomeFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(
                R.id.container, new HomeFragment(MainActivity.this)).commit();
