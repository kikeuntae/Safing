...
public class Product_Purchase_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //========= 구매자 정보 자동 입력============
        product_purchase_orderer_tv1.setText(login_vo.getMember_name());

        String readStr = login_vo.getMember_phone(); // 번호 나누기
        String phone1 = readStr.split("-")[0];
        String phone2 = readStr.split("-")[1];
        String phone3 = readStr.split("-")[2];

        product_purchase_orderer_tv2.setText(phone1);
        product_purchase_orderer_tv3.setText(phone2);
        product_purchase_orderer_tv4.setText(phone3);

        product_purchase_orderer_tv1.setEnabled(false);
        product_purchase_orderer_tv2.setEnabled(false);
        product_purchase_orderer_tv3.setEnabled(false);
        product_purchase_orderer_tv4.setEnabled(false);
