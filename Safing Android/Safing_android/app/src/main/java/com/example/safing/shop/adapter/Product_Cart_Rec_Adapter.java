...
public class Product_Cart_Rec_Adapter extends RecyclerView.Adapter<Product_Cart_Rec_Adapter.ViewHolder> implements OnItemClick_Cart_Listener {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public TextView item_product_cart_rec_tv5, item_product_cart_rec_tv6;
        ...
        public void binding(ViewHolder holder, int position){
            ...
            holder.item_product_cart_rec_tv5.setText(list.get(position).getProduct_price()+"");
            holder.item_product_cart_rec_tv6.setText(list.get(position).getCart_num()+"");
                ...
                public void onClick(View v) {
                    ...
                    builder.setPositiveButton("예", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            int cart_num = list.get(position).getCart_num();

                            holder.item_product_cart_rec_box.setChecked(false);
                            delDto(position);
                            notifyDataSetChanged();
                            dao.delete_cart(cart_num);
