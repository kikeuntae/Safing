    ...
    public void deleteCheck(){
        for (int i = 0; i < adapter_rec1.viewHolders.size(); i++) {
            if(adapter_rec1.viewHolders.get(i).item_product_cart_rec_box.isChecked()){
                int cart_num = Integer.parseInt(adapter_rec1.viewHolders.get(i).item_product_cart_rec_tv6.getText()+"");

                adapter_rec1.viewHolders.get(i).item_product_cart_rec_box.setChecked(false);
    ...
    public void changePrice(){
        ...
        for (int i = 0 ; i < adapter_rec1.viewHolders.size() ; i++) {
            if(adapter_rec1.viewHolders.get(i).item_product_cart_rec_box.isChecked()){
                ...
                priceSum += Integer.parseInt(adapter_rec1.viewHolders.get(i).item_product_cart_rec_tv5.getText()+"");
            }
        }
