...
public class Address_Default_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MemberVO loginfo = MainActivity.getLogin_member();
        ...
        if(vo.getAddr_basic() == null){
            vo = dao.default_addrss(loginfo.getMember_id());
        }

        if(vo == null){
            address_defualt_tv1.setText("");
            address_defualt_tv2.setText("");
            address_defualt_tv3.setText("");
            address_defualt_tv4.setText("");
            address_defualt_tv5.setText("");
            address_defualt_tv6.setText("");
            address_defualt_tv7.setText("");

        } else if(!("").equals(vo.getReceiver_name())){
        ...
        address_defualt_box1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(vo == null){
                    ...
                    if(("y").equals(vo.getAddr_setting()) && button_chk2 ==false){
